...
서버 전달 문서는 `docs/server-handoff-v5.md`.
...
- **①번 줄만 4초에 낼 수 있다** — 동기 단일 응답이라 지금은 데이트 검색까지 기다린다.
  2단계 호출안을 `docs/server-handoff-v5.md` 7장에 올려뒀다. **지금은 안 하는 쪽을
...
### 협의 — `docs/contract-review.md` · `docs/server-handoff-v5.md` 참조

- [ ] **서버 담당자: `docs/server-handoff-v5.md` 전달** — `SKIPPED` 처리와

...
| `case13_mukbang` | **유튜브 화제 갈래** — 먹방 얘기 → 먹방 영상. 데이트 코스는 미발동해야 한다 |
| `case14_wakbubol` | **유튜브 화제 갈래** — 고유명사(왁뿌볼)가 검색어에 살아남는지. 뭉개면 엉뚱한 ASMR 이 온다 |
| `case15_planning` | **말투 + 데이트 동시 발동** — 약속 잡다가 한쪽이 답답해진다. 가장 무거운 요청(7~8초) |
